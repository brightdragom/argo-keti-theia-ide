...
kubectl apply -f ./pv/k8s-theia-pvc03.yml
kubectl apply -f ./pv/k8s-theia-pv04.yml
kubectl apply -f ./pv/k8s-theia-pvc04.yml

kubectl apply -f ./pv/k8s-theia-dind-pv03.yml
kubectl apply -f ./pv/k8s-theia-dind-pvc03.yml
kubectl apply -f ./pv/k8s-theia-dind-pv04.yml
kubectl apply -f ./pv/k8s-theia-dind-pvc04.yml
...
kubectl apply -f ./ingress/k8s-theia-ingress-slim2.yml
